...
<body class="bg-[#FEFEFE]">
    <header class="flex items-center py-[1.5rem] max-w-[80rem] m-auto justify-between">
        ...
        <nav class="flex items-center gap-[3.5rem]">
            <a href="/colect" class="text-[#171717] font-semibold text-[1rem]">Collection</a>
                ...
                <div class="flex flex-col items-start w-full">
                    <div class="flex items-center w-full justify-between">
                        ...
                        <div class="flex items-center gap-[0.25rem] bg-[#F9F9F9] rounded-[1rem] p-[0.38rem]">
                            ...
                            <a href="./colect-two" class="p-[0.62rem] rounded-[0.5rem]"><img
                ...
                <div class="flex items-start gap-[3.5rem]">
                    ...
                    <div class="w-[55.9rem] flex flex-col gap-[2.5rem] items-center">
                        <div class="grid grid-profile">
                            <div
                                class="p-[0.75rem] w-full h-[17rem]  flex flex-col items-start gap-[1rem] bg-grid-card">
                                ...
                                <div class="parent">
                                    <div class="div1 bg-no-repeat bg-cover bg-bottom bg-center w-full rounded-[0.5rem]"
                                        style="background-image: url('img/card.png');"> </div>
