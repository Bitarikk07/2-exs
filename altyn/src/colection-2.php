        ...
        <div class="flex flex-col items-start w-full">
          <div class="flex items-center w-full justify-between">
            ...
            <div class="flex items-center gap-[0.25rem] bg-[#F9F9F9] rounded-[1rem] p-[0.38rem]">
              <a href="./colection.php" class="p-[0.62rem] rounded-[0.5rem] "><img src="./assets/img/post/four.svg" alt=""></a>
              <a href="./colection-2.php" class="p-[0.62rem] rounded-[0.5rem] bg-[#DCF06B]"><img src="./assets/img/post/six.svg" alt=""></a>
            </div>
          </div>
        </div>
